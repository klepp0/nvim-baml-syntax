...
enum ts_symbol_identifiers {
  ...
  sym_class_declaration = 42,
  sym_enum_declaration = 43,
  sym_test_declaration = 44,
  sym_generator_declaration = 45,
  sym_retry_policy_declaration = 46,
  sym_template_string_declaration = 47,
