...
enum ts_symbol_identifiers {
  ...
  sym_test_declaration = 45,
  sym_generator_declaration = 46,
  sym_retry_policy_declaration = 47,
  sym_template_string_declaration = 48,
